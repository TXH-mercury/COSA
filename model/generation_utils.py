    ...
    def contrastive_search(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            model_kwargs = self._update_model_kwargs_for_generation(
                outputs, model_kwargs, is_encoder_decoder=self.config.is_encoder_decoder, next_tokens=next_tokens
            )
    ...
    def beam_search(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            model_kwargs = self._update_model_kwargs_for_generation(
                outputs, model_kwargs, is_encoder_decoder=self.config.is_encoder_decoder, next_tokens=beam_next_tokens
            )
